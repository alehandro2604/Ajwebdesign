...
// Add mobile detection and alternative animations
...
if (isMobile) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Simple fade-in for text elements without ScrollTrigger
    ...
    // Make sure nav is visible on mobile
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
    ...
    // Then initialize your animations
    initAnimations();
  } else {
...
// Add this to your main.js to debug mobile issues
window.addEventListener('error', function(e) {
  ...
  if (!document.getElementById('error-display')) {
    ...
    errorEl.style.background = 'rgba(255,0,0,0.7)';
  ...
  document.getElementById('error-display').innerHTML += `<p>${e.message}</p>`;
});
